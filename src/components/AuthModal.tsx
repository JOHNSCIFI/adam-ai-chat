...
export default function AuthModal({ isOpen, onClose, onSuccess }: AuthModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl w-[85vw] m-8 p-0 bg-background border border-border shadow-2xl rounded-3xl overflow-hidden">
          ...
          <div className="w-full md:w-1/2 bg-gradient-to-br from-background to-muted/30 p-8 md:p-12 flex flex-col items-center justify-center border-r border-border">
            ...
            <div className="text-center mb-8">
              ...
              <div className="flex gap-4 justify-center flex-wrap">
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-background to-muted/20 flex items-center justify-center hover:scale-110 transition-transform">
                ...
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-background to-muted/20 flex items-center justify-center hover:scale-110 transition-transform">
                  <img src="/chrome-icon.svg" alt="Chrome" className="w-8 h-8" />
                </div>
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-background to-muted/20 flex items-center justify-center hover:scale-110 transition-transform">
                  <img src="/firefox-icon.svg" alt="Firefox" className="w-8 h-8" />
                </div>
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-background to-muted/20 flex items-center justify-center hover:scale-110 transition-transform">
                  <img src="/edge-icon-new.svg" alt="Edge" className="w-8 h-8" />
                </div>
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-background to-muted/20 flex items-center justify-center hover:scale-110 transition-transform">
                  <img src="/safari-icon-new.svg" alt="Safari" className="w-8 h-8" />
                </div>
                <div className="w-14 h-14 rounded-2xl bg-gradient-to-br from-background to-muted/20 flex items-center justify-center hover:scale-110 transition-transform">
