...
import safariLogo from "@/assets/safari-icon.png";
import whatsappLogo from "@/assets/whatsapp-icon.png";
import chatgptLogo from "@/assets/chatgpt-logo.png";
import anthropicLogo from "@/assets/anthropic-icon.png";
...
export default function AuthModal({ isOpen, onClose, onSuccess }: AuthModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-5xl w-[90vw] p-0 bg-background border border-border shadow-2xl rounded-3xl overflow-hidden">
        ...
        <div className="flex flex-col md:flex-row min-h-[600px]">
          ...
          <div className="w-full md:w-1/2 bg-gradient-to-br from-background to-muted/30 p-8 md:p-12 flex flex-col items-center justify-center border-r border-border">
            ...
            {/* Available On */}
            <div className="text-center mb-8">
              <div className="text-sm text-muted-foreground mb-4">Available on</div>
              <div className="flex gap-3 justify-center flex-wrap">
                {/* Google Play */}
                <div className="w-12 h-12 rounded-xl bg-background border border-border flex items-center justify-center shadow-sm hover:shadow-md transition-shadow">
                ...
                {/* Chrome */}
                <div className="w-12 h-12 rounded-xl bg-background border border-border flex items-center justify-center shadow-sm hover:shadow-md transition-shadow">
                  <img src={chromeLogo} alt="Chrome" className="w-7 h-7 object-contain" />
                </div>
                {/* Firefox */}
                <div className="w-12 h-12 rounded-xl bg-background border border-border flex items-center justify-center shadow-sm hover:shadow-md transition-shadow">
                  <img src={firefoxLogo} alt="Firefox" className="w-7 h-7 object-contain" />
                </div>
                {/* Microsoft Edge */}
                <div className="w-12 h-12 rounded-xl bg-background border border-border flex items-center justify-center shadow-sm hover:shadow-md transition-shadow">
                  <img src={edgeLogo} alt="Edge" className="w-7 h-7 object-contain" />
                </div>
                {/* Safari */}
                <div className="w-12 h-12 rounded-xl bg-background border border-border flex items-center justify-center shadow-sm hover:shadow-md transition-shadow">
                  <img src={safariLogo} alt="Safari" className="w-7 h-7 object-contain" />
                </div>
                {/* WhatsApp */}
                <div className="w-12 h-12 rounded-xl bg-background border border-border flex items-center justify-center shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="mb-6">
              ...
              <div className="flex gap-5 justify-end items-center">
                <div className="flex items-center gap-2">
                  <img src={chatgptLogo} alt="OpenAI" className="w-6 h-6 object-contain" />
                  <span className="text-sm font-medium">OpenAI</span>
                </div>
                <div className="flex items-center gap-2">
                  <img src={anthropicLogo} alt="Anthropic" className="w-6 h-6 object-contain" />
                  <span className="text-sm font-medium">Anthropic</span>
                </div>
                <div className="flex items-center gap-2">
                  <img src={geminiLogo} alt="Google" className="w-6 h-6 object-contain" />
