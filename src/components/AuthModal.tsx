...
export default function AuthModal({ isOpen, onClose, onSuccess }: AuthModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl w-[85vw] mx-auto my-8 p-0 bg-gradient-to-br from-background via-background to-muted/10 border-2 border-border/50 shadow-2xl rounded-3xl overflow-hidden backdrop-blur-sm">
        ...
        <div className="flex flex-col md:flex-row min-h-[550px]">
          ...
          <div className="w-full md:w-1/2 bg-gradient-to-br from-primary/5 via-primary/3 to-transparent p-8 md:p-12 flex flex-col items-center justify-center border-r border-border/30">
            {/* Badge and Rating */}
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-4 mb-4">
                <svg className="w-14 h-14 text-primary/40" viewBox="0 0 100 150" fill="currentColor">
                ...
                <svg className="w-14 h-14 text-primary/40 scale-x-[-1]" viewBox="0 0 100 150" fill="currentColor">
                  <path d="M10 50 Q10 10 50 10 Q90 10 90 50 L90 80 Q90 120 50 120 Q10 120 10 80 Z M25 30 L35 50 L20 50 Z M65 50 L75 30 L80 50 Z"/>
                </svg>
              </div>
              ...
              <div className="text-4xl font-bold bg-gradient-to-r from-primary to-primary/60 bg-clip-text text-transparent mb-2">35M+ users</div>
            </div>

            {/* Available On */}
            <div className="text-center mb-10">
              <div className="text-sm font-semibold text-muted-foreground mb-5 uppercase tracking-wider">Available on</div>
              <div className="flex gap-3 justify-center flex-wrap">
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-background/80 to-background/40 backdrop-blur-sm flex items-center justify-center hover:scale-110 hover:shadow-lg transition-all duration-300 cursor-pointer">
                ...
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-background/80 to-background/40 backdrop-blur-sm flex items-center justify-center hover:scale-110 hover:shadow-lg transition-all duration-300 cursor-pointer">
                  <img src="/chrome-icon.svg" alt="Chrome" className="w-9 h-9" />
                </div>
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-background/80 to-background/40 backdrop-blur-sm flex items-center justify-center hover:scale-110 hover:shadow-lg transition-all duration-300 cursor-pointer">
                  <img src="/firefox-icon.svg" alt="Firefox" className="w-9 h-9" />
                </div>
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-background/80 to-background/40 backdrop-blur-sm flex items-center justify-center hover:scale-110 hover:shadow-lg transition-all duration-300 cursor-pointer">
                  <img src="/edge-icon-new.svg" alt="Edge" className="w-9 h-9" />
                </div>
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-background/80 to-background/40 backdrop-blur-sm flex items-center justify-center hover:scale-110 hover:shadow-lg transition-all duration-300 cursor-pointer">
                  <img src="/safari-icon-final.svg" alt="Safari" className="w-9 h-9" />
                </div>
                <div className="w-16 h-16 rounded-2xl bg-gradient-to-br from-background/80 to-background/40 backdrop-blur-sm flex items-center justify-center hover:scale-110 hover:shadow-lg transition-all duration-300 cursor-pointer">
            ...
            <div className="text-center">
              <h3 className="text-2xl font-bold bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent">Trusted by Millions</h3>
            </div>
          </div>
          ...
          <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col">
            {/* Powered By */}
            <div className="mb-8">
              <div className="text-xs font-semibold text-muted-foreground text-right mb-4 uppercase tracking-wider">Powered By</div>
              <div className="flex gap-5 justify-end items-center flex-wrap">
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors">
                  <img src="/openai-icon.svg" alt="OpenAI" className="w-6 h-6" />
                  <span className="text-sm font-semibold">OpenAI</span>
                </div>
                <div className="flex items-center gap-2 px-3 py-2 rounded-lg bg-muted/30 hover:bg-muted/50 transition-colors">
                  <img src="/anthropic-icon.svg" alt="Anthropic" className="w-6 h-6" />
            ...
            {/* Main Heading */}
            <div className="mb-8">
              <h2 className="text-3xl md:text-4xl font-bold leading-tight bg-gradient-to-r from-foreground via-foreground to-muted-foreground bg-clip-text text-transparent">
