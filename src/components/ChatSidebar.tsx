  ...
  return (
    <>
      <Sidebar className="border-r border-sidebar-border bg-sidebar" collapsible="icon">
        <SidebarHeader className="pt-5 px-1 pb-4">
          <Button 
            onClick={handleNewChat}
            className={`ml-1 bg-transparent hover:bg-sidebar-accent text-sidebar-foreground transition-all duration-200 ${
              collapsed ? 'h-10 w-10 p-0 rounded-lg' : 'h-10 w-full justify-start gap-2 px-3 rounded-lg'
            }`}
            size="sm"
            variant="ghost"
          >
