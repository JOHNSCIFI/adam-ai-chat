          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div className="animate-fade-in">
              <div className="flex items-center gap-4 mb-8">
                ...
                <div className="w-8 h-8 bg-white dark:bg-gray-900 border border-border rounded-lg flex items-center justify-center p-1 shadow-sm">
        ...
        <div className="container max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            animationDelay: '0.3s'
              ...
              <div className="relative z-10 text-center">
                <div className="w-16 h-16 rounded-2xl bg-white dark:bg-gray-900 flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform duration-300 p-2">
