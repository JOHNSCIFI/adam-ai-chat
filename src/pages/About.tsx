...
const About = () => {
  return (
    <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <SEO 
        title="About Us"
        description="Learn about AdamGpt, your complete AI assistant platform offering access to multiple AI models including GPT-4o, Claude, Gemini and DeepSeek."
      />
      
      <div className="max-w-4xl mx-auto">
        <h1 className="text-4xl font-bold text-foreground mb-8">About AdamGpt</h1>
        
        <div className="prose prose-lg max-w-none text-muted-foreground">
          <p className="text-xl mb-6">
            AdamGpt is your gateway to the world's most advanced AI models, all in one unified platform.
          </p>
          ...
          <p className="mb-6">
            ...
            student, or business owner, AdamGpt provides the tools you need to enhance your productivity and creativity.
          </p>
          
          <p>
            Join thousands of users who trust AdamGpt for their daily AI needs and discover the power of having 
