      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="relative">
          <div className="flex gap-4 overflow-x-auto px-8" ref={modelsContainerRef}>
            {availableModels.map(model => <div key={model.id} className={`flex-shrink-0 w-80 p-4 rounded-lg border cursor-pointer transition-all hover:shadow-md ${model.selected ? 'border-primary bg-primary/5' : 'border-border bg-background'}`} onClick={() => handleModelSelect(model.id)}>
